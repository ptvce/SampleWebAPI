...
{
    public partial class AdventureWorkSampleDBContext : DbContext
    {
        public AdventureWorkSampleDBContext()
        {
        }

        public AdventureWorkSampleDBContext(DbContextOptions<AdventureWorkSampleDBContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=AdventureWorkSampleDB;integrated security=true");
            }
        }
